                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button id="notification-icon"
                                ...
                                <div class="ms-1">
                                    <img src="votre-chemin-vers-l-image-sans-notifications.png"
                                        alt="Icône de cloche de notification" id="notification-image">
                                </div>
                            </button>
                        </x-slot>
                        <x-slot name="content">
                            @foreach ($notifications as $notification)
                                @if (isset($notification->data['appartement_id']))
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var imagePath1 = "{{ asset('logo/bell.svg') }}";
        var imagePath2 = "{{ asset('logo/bell-ringing.svg') }}";


        function updateNotificationIcon() {
            if (notificationsCount > 0) {
                notificationImage.src = imagePath2;
            } else {
